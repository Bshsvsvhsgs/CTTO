...
coroutine.wrap(function()
    ...
    Chill_Gui_Label.Text = "~Ã‚Â»Chill GuiÃ‚Â«~"
    ...
    Chat_Toggle_Label.Text = "~Ã‚Â»FalseÃ‚Â«~"
    ...
    Current_Song_Label.Text = "~Ã‚Â»Current Song: NoneÃ‚Â«~"
    ...
    if tonumber(ID_Box.Text) then
        ...
        text.Text = "~Ã‚Â»Chill AfÃ‚Â«~ Now Playing: "..currentsong
        Current_Song_Label.Text = "~Ã‚Â»Current Song: "..currentsong.."Ã‚Â«~"
    wait(4)
    text.Text = "~Ã‚Â»Fell Apart AFÃ‚Â«~"
    end
    end)
